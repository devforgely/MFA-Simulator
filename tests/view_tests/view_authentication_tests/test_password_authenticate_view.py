...
from views.authentication.password_view import PasswordAuthenticateView
from viewmodels.authentication.password_viewmodel import PasswordAuthenticateViewModel
from widgets.info_panel import *
from models.authentication.authentication import Method
import json


class TestPasswordAuthenticateView(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    @patch.object(PasswordAuthenticateViewModel, 'state_data')
    ...
    def setUp(self, note_file_path, simulation_note_path, user_file_path, mock_state_data):
        ...
        mock_state_data.return_value = {"user_registered": "", "hashed_secret": "", "salt": ""}
        ...
        self.view = PasswordAuthenticateView(viewmodel=PasswordAuthenticateViewModel(), info_panel=self.info_panel, parent=self.parent, ui="src/views_ui/authenticate_views/password_view.ui")
        self.parent.show()
    ...
    def test_update_state(self):
        ...
        self.assertEqual(self.view.password_field.text(), "")

    def test_update_data(self):
        self.view.update_data({"timestamp_authenticate": "", "username": "", "password": ""}, 1)
